...
@NgModule({
  declarations: [AppComponent,InspectSettingBoxComponent,ScanComponent,PartsComponent],
  entryComponents:[InspectSettingBoxComponent,ScanComponent,PartsComponent],
  imports: [
    BrowserModule,
    IonicModule.forRoot(),
    AppRoutingModule,
